...
const Navber = () => {
    return (
        <div className="w-10/12 mx-auto flex justify-between py-4">
            ...
            <div className="flex gap-12 text-[#150B2BB3] text-base font-normal items-center">
                <a href="">Home</a>
                <a href="">Recipes</a>
                <a href="">About</a>
                <a href="">Search</a>
            ...
            <div className="relative flex items-center">
                ...
                <input className="bg-[#150B2B0D] rounded-full px-7 py-2" type="text" placeholder="search" />
