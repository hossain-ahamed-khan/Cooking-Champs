        ...
        <div className="w-10/12 mx-auto">
            <div className='w-full relative'>
                ...
                <div className='w-9/12 mx-auto absolute top-1/4 left-36 text-white text-center'>
                    ...
                    <p className='text-lg font-normal my-5'>Learn and Master Basic Programming, Data Structures, Algorithm, OOP, Database and solve 500+ coding problems to become an exceptionally well world-class Programmer.</p>
